...
export default class ADinfo extends Component {
    ...
    render() {
        return (
                ...
                {parseInt(this.state.data.rate) >= 2 ? <Image source={require('../images/logos/star_active.png')}
                style={{width: 20, height: 20, marginRight: 3}}/> : <Image source={require('../images/logos/star.png')}
                style={{width: 20, height: 20, marginRight: 3}}/>}
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.update_star(3)}>
                {parseInt(this.state.data.rate) >= 3 ? <Image source={require('../images/logos/star_active.png')}
                style={{width: 20, height: 20, marginRight: 3}}/> : <Image source={require('../images/logos/star.png')}
                style={{width: 20, height: 20, marginRight: 3}}/>}
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.update_star(4)}>
                {parseInt(this.state.data.rate) >= 4 ? <Image source={require('../images/logos/star_active.png')}
                style={{width: 20, height: 20, marginRight: 3}}/> : <Image source={require('../images/logos/star.png')}
                style={{width: 20, height: 20, marginRight: 3}}/>}
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.update_star(5)}>
                {parseInt(this.state.data.rate) == 5 ? <Image source={require('../images/logos/star_active.png')}
                style={{width: 20, height: 20, marginRight: 3}}/> : <Image source={require('../images/logos/star.png')}
                style={{width: 20, height: 20, marginRight: 3}}/>}
                </TouchableOpacity>
                </View>
                ...
                <View style={{justifyContent: 'center', flexDirection: 'row', marginBottom: 10,marginRight:20}}>
                <Image
                ...
                <Text style={{fontSize: 20, textAlign: 'right', marginRight: 20,fontFamily:'IRANSansMobile'}}>{this.state.data.description}</Text>
                </View>
                            ...
                            {this.state.data.related.map((item) =>
                                <View style={{flexDirection: 'column', marginRight: 30}} key={item.id}>
                                    <View style={{
                                        ...
                                        <View>
                                        <Text style={{fontSize:14,fontFamily:'IRANSansMobile',textAlign:'left',marginLeft:'5%',marginTop:5}}>{item.title}</Text>
                                        </View>
                                    </View>
                                    <TouchableOpacity
                                        onPress={() => {
                ...
                {this.state.comments_loaded && this.state.comments.map((item) =>
                                                                       ...
                                                                       <Text style={{fontSize:15,marginLeft:10,textAlign:'right',marginTop:3}}>:کاربر {item.username}</Text>
                ...
                <View style={{backgroundColor:'#66a3ff',borderRadius:10,color:'#cce0ff',marginRight:3}}>
                <Button title="ثبت"  onPress={() => this.submit_comment(this.state.com)} />
                </View>
                </View>
                <View style={{alignItems:"center"}}>
                <Text style={{fontSize:15,color:'blue',textAlign:'center',paddingRight:10,paddingLeft:10,borderWidth:1,borderColor:'#66a3ff',borderRadius:10}} onPress={() => {
                this.comments_view();
                }}>نظرات بیشتر</Text>
                </View>
                </View>
