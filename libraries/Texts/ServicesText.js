        ...
        return (
            <View style={{flexDirection: 'row',justifyContent:'space-between',marginTop:20}}>
                ...
                <View style={{alignItems:"flex-end",justifyContent:"flex-end",flexDirection: 'row'}}>
                    <Text style={{fontSize:25,marginLeft:10,fontFamily:'IRANSansMobile'}}>خدمات</Text>
                    <Image source={require('../../images/logos/services.png')} style={{width:32,height:32,marginLeft:5,marginRight:5,marginBottom:6}} />
                </View>
            </View>
        );
    }
